        ...
        <form class="form-horizontal" action='PregledController' method='POST'>
          ...
          <div class="form-group col-sm-offset-4 col-sm-offset-4">
            <label for="idP" class="col-sm-4 control-label">ID pacijenta</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="pacijentID" id="idP" value="<c:out value="${pacijentID}"></c:out>"/>
              </div>
          </div>
          ...
          <div class="form-group col-sm-offset-4 col-sm-offset-4">
            <label for="lekar" class="col-sm-4 control-label">ID lekara</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="lekarID" id="lekar" value="<c:out value="${lekarID}"></c:out>"/>  
              </div>
          </div>
          ...
          <div class="form-group col-sm-offset-4 col-sm-offset-4">
            <label for="nalaz" class="col-sm-4 control-label">Nalaz</label>
              <div class="col-sm-4">
                <textarea class="form-control" rows="5" name="nalaz" id="nalaz"></textarea>
              </div>
          </div>
